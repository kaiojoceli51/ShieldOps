...
- Under the latest release, look for a file that ends with `.exe`. This is the installer for Windows.
- Click the `.exe` file to download it to your PC.
